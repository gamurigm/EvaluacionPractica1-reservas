...
\begin{description}
    ...
    \item[Código Limpio (Clean Code)] Conjunto de reglas y principios que facilitan la escritura de software que sea fácil de leer, entender y mantener.
    ...
    \item[Pruebas de Estrés] Evaluación del comportamiento de un sistema cuando es sometido a cargas de trabajo extremas, más allá de su capacidad normal.
